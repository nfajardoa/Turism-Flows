...
label variable  accion_farc			"Numero de acciones de las FARC"
...
global xtmodels2 ""l_pib l_dist l_itcr l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc" "l_pib l_dist l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc" "l_pib l_dist l_itcr l_comercio_usd_2010 ll_giro_rem accion_farc" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010 ll_giro_rem accion_farc" "l_pib l_dist l_itcr l${xtendog} l_comercio_usd_2010 accion_farc" "l_pib l_dist l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 accion_farc""
global xtmodels3 ""l_pib l_dist l_itcr l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1" "l_pib l_dist l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1" "l_pib l_dist l_itcr l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1" "l_pib l_dist l_itcr l${xtendog} l_comercio_usd_2010 accion_farc l_habs_1" "l_pib l_dist l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 accion_farc l_habs_1""
global xtmodels4 ""l_pib l_dist l_itcr l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc l_sillas" "l_pib l_dist l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc l_sillas" "l_pib l_dist l_itcr l_comercio_usd_2010 ll_giro_rem accion_farc l_sillas" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010 ll_giro_rem accion_farc l_sillas" "l_pib l_dist l_itcr l${xtendog} l_comercio_usd_2010 accion_farc l_sillas" "l_pib l_dist l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 accion_farc l_sillas""
global xtmodels5 ""l_pib l_dist l_itcr l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1 l_sillas" "l_pib l_dist l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1 l_sillas" "l_pib l_dist l_itcr l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1 l_sillas" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1 l_sillas" "l_pib l_dist l_itcr l${xtendog} l_comercio_usd_2010 accion_farc l_habs_1 l_sillas" "l_pib l_dist l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 accion_farc l_habs_1 l_sillas""
...
outreg2 using Estimates_small_19paises_${xtendog}_${s_year}_${f_year}_accion-FARC_07-06-2018.xls, excel append label sortvar(l_pib l_dist l_itcr l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1 ll_sillas) dec(2) 
...
xthtaylor ${xtendog} `x' if ${s_year}<=year & year<=${f_year} & pais_num < 20, endog(${xtendog}) constant(${xtconst})  small 
outreg2 using Estimates_small_19paises_${xtendog}_${s_year}_${f_year}_accion-FARC_07-06-2018.xls, excel append label sortvar(l_pib l_dist l_itcr l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1 l_sillas) dec(2) 
replace count 		= count + 1
global counter 		= count
}
