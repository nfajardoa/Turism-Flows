...
label variable  pob_col				"Poblacion colombiana"
...
by pais_num: gen habsph			= (habs*100000)/pob_col
by pais_num: gen habsph_1		= (habs_1*100000)/pob_col

gen  l_habsph	   = ln(habsph)
gen  l_habsph_1	   = ln(habsph_1)
...
label variable  l_habsph	            "ln Numero de habitaciones/100M habitantes"
label variable  l_habsph_1	            "ln Numero de habitaciones(t-1)/100M habitantes"
...
xthtaylor ${xtendog} l_pib l_dist l_itcr espanol tlc y2002-y2017 if ${s_year}<=year & year<=${f_year} & pais_num<=${n_countries} , endog(${xtendog}) constant(${xtconst}) small 
...
global xtmodels ""l_pib l_dist" "l_pib l_dist l_itcrt" "l_pib l_dist l_itcrbinv lspex""
global xtmodels1 ""l_pib l_dist l_itcrt l_comercio_usd_2010_resid" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010_resid""
global xtmodels2 ""l_pib l_dist l_itcrt l_comercio_usd_2010_resid ll_giro_rem conflicto" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010_resid ll_giro_rem conflicto" "l_pib l_dist l_itcrt l_comercio_usd_2010_resid conflicto" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010_resid conflicto""
global xtmodels3 ""l_pib l_dist l_itcrt l_comercio_usd_2010_resid ll_giro_rem conflicto l_habsph_1" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010_resid ll_giro_rem conflicto l_habsph_1" "l_pib l_dist l_itcrt  l_comercio_usd_2010_resid conflicto l_habsph_1" "l_pib l_dist l_itcrbinv lspex  l_comercio_usd_2010_resid conflicto l_habsph_1""
global xtmodels4 ""l_pib l_dist l_itcrt  l_comercio_usd_2010_resid ll_giro_rem conflicto l_sillas" "l_pib l_dist l_itcrbinv lspex  l_comercio_usd_2010_resid ll_giro_rem conflicto l_sillas" "l_pib l_dist l_itcrt  l_comercio_usd_2010_resid conflicto l_sillas" "l_pib l_dist l_itcrbinv lspex  l_comercio_usd_2010_resid conflicto l_sillas""
global xtmodels5 ""l_pib l_dist l_itcrt  l_comercio_usd_2010_resid ll_giro_rem conflicto l_habsph_1 l_sillas" "l_pib l_dist l_itcrbinv lspex  l_comercio_usd_2010_resid ll_giro_rem conflicto l_habsph_1 l_sillas" "l_pib l_dist l_itcrt  l_comercio_usd_2010_resid conflicto l_habsph_1 l_sillas" "l_pib l_dist l_itcrbinv lspex  l_comercio_usd_2010_resid conflicto l_habsph_1 l_sillas""

foreach x of global xtmodels{

xthtaylor ${xtendog} `x' y2001-y2017 if ${s_year}<=year & year<=${f_year} & pais_num<=${n_countries} , endog(${xtendog}) constant(${xtconst})  small 
outreg2 using Estimates_small_2etapas_${n_countries}paises_${xtendog}_${s_year}-${f_year}_${date}_habsph_fijospa_itcrt.xls, excel append label sortvar(l_pib l_dist l_itcrt l_itcrbinv lspex l${xtendog}  l_comercio_usd_2010_resid ll_giro_rem conflicto l_habsph_1 ll_sillas y2001-y2017) dec(2) 
