...
label variable  tlc					"Tiene un crisis frontera colonia espanol tlc con Colombia"
...
global xtmodels  ""dl_pib crisis frontera colonia espanol tlc" "dl_pib  dl_itcr crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex crisis frontera colonia espanol tlc""
global xtmodels1 ""dl_pib  dl_itcr dl_comercio_usd_2010 crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 crisis frontera colonia espanol tlc""
global xtmodels2 ""dl_pib  dl_itcr dl_comercio_usd_2010 dll_giro_rem conflicto crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 dll_giro_rem conflicto crisis frontera colonia espanol tlc" "dl_pib  dl_itcr dl_comercio_usd_2010 dll_giro_rem conflicto crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 dll_giro_rem conflicto crisis frontera colonia espanol tlc" "dl_pib  dl_itcr dl_comercio_usd_2010 conflicto crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 conflicto crisis frontera colonia espanol tlc""
global xtmodels3 ""dl_pib  dl_itcr dl_comercio_usd_2010 dll_giro_rem conflicto dl_habs_1 crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex  dl_comercio_usd_2010 dll_giro_rem conflicto dl_habs_1 crisis frontera colonia espanol tlc" "dl_pib  dl_itcr dl_comercio_usd_2010 dll_giro_rem conflicto dl_habs_1 crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 dll_giro_rem conflicto dl_habs_1 crisis frontera colonia espanol tlc" "dl_pib  dl_itcr dl_comercio_usd_2010 conflicto dl_habs_1 crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 conflicto dl_habs_1 crisis frontera colonia espanol tlc""
global xtmodels4 ""dl_pib  dl_itcr dl_comercio_usd_2010 dll_giro_rem conflicto dl_sillas crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex  dl_comercio_usd_2010 dll_giro_rem conflicto dl_sillas crisis frontera colonia espanol tlc" "dl_pib  dl_itcr dl_comercio_usd_2010 dll_giro_rem conflicto dl_sillas crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 dll_giro_rem conflicto dl_sillas crisis frontera colonia espanol tlc" "dl_pib  dl_itcr dl_comercio_usd_2010 conflicto dl_sillas crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 conflicto dl_sillas crisis frontera colonia espanol tlc""
global xtmodels5 ""dl_pib  dl_itcr dl_comercio_usd_2010 dll_giro_rem conflicto dl_habs_1 dl_sillas crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 dll_giro_rem conflicto dl_habs_1 dl_sillas crisis frontera colonia espanol tlc" "dl_pib  dl_itcr dl_comercio_usd_2010 dll_giro_rem conflicto dl_habs_1 dl_sillas crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 dll_giro_rem conflicto dl_habs_1 dl_sillas crisis frontera colonia espanol tlc" "dl_pib  dl_itcr dl_comercio_usd_2010 conflicto dl_habs_1 dl_sillas crisis frontera colonia espanol tlc" "dl_pib  dl_itcrbinv dlspex dl_comercio_usd_2010 conflicto dl_habs_1 dl_sillas crisis frontera colonia espanol tlc""
...
outreg2 using Estimates_small_19paises_${xtendog}_${s_year}_${f_year}_Diff_SinDist_todas_13-06-2018.xls, excel append label sortvar(dl_pib  dl_itcr dl_itcrbinv dlspex dl_comercio_usd_2010 dll_giro_rem conflicto dl_habs_1 dll_sillas crisis frontera colonia espanol tlc) dec(2) 
...
crisis frontera colonia espanol tlcolor(gs5) grid glwidth(0.0001) glcolor(gs15)) graphregion(margin(r=6 l=2 t=2 b=2)) xtitle("", size(vsmall)) ytitle("" , size(vsmall)) ///
ylabel(#10, labcolor(gs8) crisis frontera colonia espanol tlcolor(gs5) grid glwidth(0.0001) glcolor(gs15) labsize(small) angle(horizontal))
...
xlabel(2005(5)2017, labcolor(gs8) crisis frontera colonia espanol tlcolor(gs5) grid glwidth(0.0001) glcolor(gs15)) graphregion(margin(r=6 l=2 t=2 b=2)) xtitle("", size(vsmall)) ytitle("Millones" , size(vsmall)) ///
ylabel(#10, labcolor(gs8) crisis frontera colonia espanol tlcolor(gs5) grid glwidth(0.0001) glcolor(gs15) labsize(small) angle(horizontal))  graphregion(fcolor(white)) plotregion(fcolor(white) margin(r=10)) legend(on  region(lcolor(white)) rows(2))
