...
outreg2 using Estimates_small_19paises_bootstrap_${xtendog}_${s_year}_${f_year}_accion-FARC_07-06-2018.xls, excel append label sortvar(l_pib l_dist l_itcr l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem accion_farc l_habs_1 l_sillas) dec(2) 
