...
global xtmodels1 ""l_pib l_dist l_itcrbinv lspex crisis" "l_pib l_dist l_itcrbinv lspex frontera" "l_pib l_dist l_itcrbinv lspex colonia" "l_pib l_dist l_itcrbinv lspex espanol" "l_pib l_dist l_itcrbinv lspex tlc" "l_pib l_dist l_itcrbinv lspex crisis frontera colonia espanol tlc""
global xtmodels2 ""l_pib l_dist l_itcr crisis" "l_pib l_dist l_itcr frontera" "l_pib l_dist l_itcr colonia" "l_pib l_dist l_itcr espanol" "l_pib l_dist l_itcr tlc" "l_pib l_dist l_itcr espanol tlc" "l_pib l_dist l_itcr espanol frontera tlc" "l_pib l_dist l_itcr crisis frontera colonia espanol tlc""



foreach x of global xtmodels{
global xtconst = cond(count!=(5|11), "l_dist frontera", "l_dist")
global xtconst = cond(count!=(6|12), "l_dist colonia" ,"l_dist")
global xtconst = cond(count!=(7|13), "l_dist espanol" ,"l_dist")
global xtconst = cond(count!=(9|15), "l_dist frontera colonia espanol" ,"l_dist")
global xtconst = cond(count==(5|6|7|9|11|12|13|15), "l_dist", "")
xthtaylor ${xtendog} `x' if ${s_year}<=year & year<=${f_year} & pais_num<=${n_countries} , endog(${xtendog}) constant(${xtconst})  small 
predict ${xtendog}_modelo_${counter}, ue
outreg2 using Estimates_small_${n_countries}paises_${xtendog}_${s_year}-${f_year}_${date}.xls, excel append label sortvar(l_pib l_dist l_itcr l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem conflicto l_habs_1 ll_sillas) dec(2) 
...
xthtaylor ${xtendog} `x' if ${s_year}<=year & year<=${f_year} & pais_num<=${n_countries}, endog(${xtendog}) constant(${xtconst})  small 
predict ${xtendog}_modelo_${counter}, ue
outreg2 using Estimates_small_${n_countries}paises_${xtendog}_${s_year}-${f_year}_${date}.xls, excel append label sortvar(l_pib l_dist l_itcr l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem conflicto l_habs_1 l_sillas) dec(2) 
replace count 		= count + 1
global counter 		= count
}
...
global xtendog "l_comercio_usd_2010"
global xtconst  ""
global xtmodels ""l_pib l_dist_w" "l_pib l_dist_w l_itcr" "l_pib l_dist_w l_itcrbinv lspex""
global xtmodels1 ""l_pib l_dist_w l_itcrbinv lspex crisis" "l_pib l_dist_w l_itcrbinv lspex frontera" "l_pib l_dist_w l_itcrbinv lspex colonia" "l_pib l_dist_w l_itcrbinv lspex espanol" "l_pib l_dist_w l_itcrbinv lspex tlc" "l_pib l_dist_w l_itcrbinv lspex crisis frontera colonia espanol tlc""
global xtmodels2 ""l_pib l_dist_w l_itcr crisis" "l_pib l_dist_w l_itcr frontera" "l_pib l_dist_w l_itcr colonia" "l_pib l_dist_w l_itcr espanol" "l_pib l_dist_w l_itcr tlc" "l_pib l_dist_w l_itcr crisis frontera colonia espanol tlc""

foreach x of global xtmodels{
global xtconst = cond(count!=(5|11), "frontera", "")
global xtconst = cond(count!=(6|12), "colonia" ,"")
global xtconst = cond(count!=(7|13), "espanol" ,"")
global xtconst = cond(count!=(9|15), "frontera colonia espanol" ,"")
xthtaylor ${xtendog} `x' if ${s_year}<=year & year<=${f_year} & pais_num<=${n_countries} , endog(${xtendog}) constant(${xtconst})  small 
predict ${xtendog}_modelo_${counter}, ue
outreg2 using Estimates_small_distw_${n_countries}paises_${xtendog}_${s_year}-${f_year}_${date}.xls, excel append label sortvar(l_pib l_dist l_itcr l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem conflicto l_habs_1 ll_sillas) dec(2) 
replace count 		= count + 1
global counter 		= count
}
...
xthtaylor ${xtendog} `x' if ${s_year}<=year & year<=${f_year} & pais_num<=${n_countries}, endog(${xtendog}) constant(${xtconst})  small 
predict ${xtendog}_modelo_${counter}, ue
outreg2 using Estimates_small_distw_${n_countries}paises_${xtendog}_${s_year}-${f_year}_${date}.xls, excel append label sortvar(l_pib l_dist l_itcr l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem conflicto l_habs_1 l_sillas) dec(2) 
replace count 		= count + 1
global counter 		= count
}
...
global xtmodels ""l_pib l_dist_w" "l_pib l_dist_w l_itcr" "l_pib l_dist_w l_itcrbinv lspex""
global xtmodels1 ""l_pib l_dist_w l_itcrbinv lspex crisis" "l_pib l_dist_w l_itcrbinv lspex frontera" "l_pib l_dist_w l_itcrbinv lspex colonia" "l_pib l_dist_w l_itcrbinv lspex espanol" "l_pib l_dist_w l_itcrbinv lspex tlc" "l_pib l_dist_w l_itcrbinv lspex crisis frontera colonia espanol tlc""
global xtmodels2 ""l_pib l_dist_w l_itcr crisis" "l_pib l_dist_w l_itcr frontera" "l_pib l_dist_w l_itcr colonia" "l_pib l_dist_w l_itcr espanol" "l_pib l_dist_w l_itcr tlc"  "l_pib l_dist_w l_itcr espanol frontera tlc" "l_pib l_dist_w l_itcr crisis frontera colonia espanol tlc""

foreach x of global xtmodels{
xtreg ${xtendog} `x' if ${s_year}<=year & year<=${f_year} & pais_num<=${n_countries} , re sa
predict ${xtendog}_modelo_${counter}, ue
outreg2 using Estimates_small_re_distw_${n_countries}paises_${xtendog}_${s_year}-${f_year}_${date}.xls, excel append label sortvar(l_pib l_dist l_itcr l_itcrbinv lspex l${xtendog} l_comercio_usd_2010 ll_giro_rem conflicto l_habs_1 ll_sillas) dec(2) 
replace count 		= count + 1
global counter 		= count
}
