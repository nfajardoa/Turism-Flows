...
global xtmodels1 ""l_pib l_dist l_itcr l_comercio_usd_2010_resid" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010_resid""
global xtmodels2 ""l_pib l_dist l_itcr l_comercio_usd_2010_resid ll_giro_rem conflicto" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010_resid ll_giro_rem conflicto" "l_pib l_dist l_itcr l_comercio_usd_2010_resid conflicto" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010_resid conflicto""
global xtmodels3 ""l_pib l_dist l_itcr l_comercio_usd_2010_resid ll_giro_rem conflicto l_habsph_1" "l_pib l_dist l_itcrbinv lspex l_comercio_usd_2010_resid ll_giro_rem conflicto l_habsph_1" "l_pib l_dist l_itcr  l_comercio_usd_2010_resid conflicto l_habsph_1" "l_pib l_dist l_itcrbinv lspex  l_comercio_usd_2010_resid conflicto l_habsph_1""
global xtmodels4 ""l_pib l_dist l_itcr  l_comercio_usd_2010_resid ll_giro_rem conflicto l_sillas" "l_pib l_dist l_itcrbinv lspex  l_comercio_usd_2010_resid ll_giro_rem conflicto l_sillas" "l_pib l_dist l_itcr  l_comercio_usd_2010_resid conflicto l_sillas" "l_pib l_dist l_itcrbinv lspex  l_comercio_usd_2010_resid conflicto l_sillas""
global xtmodels5 ""l_pib l_dist l_itcr  l_comercio_usd_2010_resid ll_giro_rem conflicto l_habsph_1 l_sillas" "l_pib l_dist l_itcrbinv lspex  l_comercio_usd_2010_resid ll_giro_rem conflicto l_habsph_1 l_sillas" "l_pib l_dist l_itcr  l_comercio_usd_2010_resid conflicto l_habsph_1 l_sillas" "l_pib l_dist l_itcrbinv lspex  l_comercio_usd_2010_resid conflicto l_habsph_1 l_sillas""
...
outreg2 using Estimates_small_2etapas_${n_countries}paises_${xtendog}_${s_year}-${f_year}_${date}_habsph_fijospa_itcrbr.xls, excel append label sortvar(l_pib l_dist l_itcr l_itcrbinv lspex l${xtendog}  l_comercio_usd_2010_resid ll_giro_rem conflicto l_habsph_1 ll_sillas y2001-y2017) dec(2) 
